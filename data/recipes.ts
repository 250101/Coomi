...
export const recipes: Recipe[] = [
  {
    ...
    ingredients: [
      ...
      { name: "Sal y pimienta", quantity: 0, unit: "a gusto" },
      { name: "Peperoncino", quantity: 0, unit: "a gusto" },
    ],
    steps: [
      "Hervir agua en una olla, pelar los boniatos, cortarlos en trozos iguales para controlar mejor el tiempo de coccion y meterlos al agua hirviendo junto con el diente de ajo.",
      "Esperar a que el boniato esté blando (unos 15-20 minutos), colarlo y pasarlo a un vaso para mixear.",
      "Agregar la leche, sal y pimienta a gusto (si querés un poco de picante, recomiendo el peperoncino).",
  ...
  },
  {
    ...
    ingredients: [
      ...
      { name: "Orégano, pimienta y sal", quantity: 0, unit: "a gusto" },
  ...
  },
  {
    ...
    ingredients: [
      ...
      { name: "Pimienta", quantity: 0, unit: "a gusto" },
      { name: "Manteca", quantity: 100, unit: "g" },
    ...
    steps: [
      ...
      "Empezar a agregar el caldo caliente (1 taza a la vez), revolviendo constantemente para que el arroz lo absorba. Seguir agregando caldo y revolviendo hasta que el arroz esté en su punto (unos 30-35 minutos). Al final, debe quedar un poco líquido.",
  ...
  },
  {
    ...
    tags: ["Gourmet", "Carne"],
    ingredients: [
      { name: "Lomo de res", quantity: 500, unit: "g" },
  ...
  },
  {
    ...
    ingredients: [
      ...
      { name: "Aceite para freír", quantity: 500, unit: "ml" },
      { name: "Sal", quantity: 0, unit: "a gusto" },
    ],
    steps: [
      ...
      "Pasarlas a un bowl, agregar los 9 huevos batidos, mezclar con una cuchara y dejar reposar 10 minutos.",
  ...
  },
  {
    ...
    ingredients: [
      ...
      { name: "Cacao en polvo", quantity: 0, unit: "hasta cubrir la superficie" },
    ],
    steps: [
  ...
  },
  {
    ...
    ingredients: [
      ...
      { name: "Huevo", quantity: 1, unit: "unidad" },
      { name: "Harina", quantity: 450, unit: "g" },
    ...
    steps: [
      ...
      "En un bowl agregar la harina, la manteca derretida, el azúcar, el huevo y la levadura activada, amasar hasta formar una masa suave y dejar levar por 1 hora.",
      ...
      "Cortar en medallones de 3 dedos de ancho (unos 12 rolls), colocarlos en una asadera con papel manteca y dejar levar 30 minutos más (dejar espacio entre cada roll, ya que van a seguir levando).",
